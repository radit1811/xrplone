...
<div class="hero_area">
    ...
    <div class="buttons-container">
        ...
        <br> -->
        <h3>Pemrograman Terstruktur ( Python )</h3>
        <br>
        <a href="./python/bonus.html" target="_blank">
        <button class="button-30" role="button">Bonus (elif)</button>
        </a>
        <br>
        <br>
        <a href="./python/tipe-data-list.html" target="_blank">
        <button class="button-30" role="button">TData (list)</button>
        </a>
        <br>
        <br>
        <a href="./python/variabel.html" target="_blank">
        <button class="button-30" role="button">Variabel</button>
        </a>
